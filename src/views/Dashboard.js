    ...
    <>
      <Container fluid>
                ...
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Requests Pending</p>
          ...
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav">
                <Col lg="12" sm="16">
                  <a class="nav-item nav-link active" href="#">Applied <span class="sr-only">(current)</span></a>
                </Col>
                <Col lg="12" sm="16">
                  <a class="nav-item nav-link" href="#">Doing</a>
                </Col>
        ...
        <Row>
          ...
          < Cardi
          header = "Applied For Internship"
            name="AREEB BIN AZIM"
            university="NED University"
            description="CIS Engineer"
          />
          < Cardi
            name="AREEB BIN AZIM"
            university="NED University"
          ...
          <Col md="6">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Performance VS Target Analysis</Card.Title>
              ...
              <Card.Footer>
                <div className="legend">
                  <i className="fas fa-circle text-info"></i>
                  Target <i className="fas fa-circle text-danger"></i>
                  Performance
                </div>
                <hr></hr>
                <div className="stats">
